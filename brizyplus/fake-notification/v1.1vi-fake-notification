/*---bổ sung---------------
<link href="https://cdn.jsdelivr.net/gh/webcode24h/libs@main/fake-notification/fake-notification.css" rel="stylesheet">
...
function checkCookie() {
	...
	if (user == "") {
		...
		setTimeout(function() {
			document.querySelector("#name_type_item").innerHTML = "Đã mua&ensp;" + (r_name_type_item[Math.floor(7 * Math.random())]) + "&emsp;🕐 Vừa xong";
		}, 5000);
		setTimeout(function() {
